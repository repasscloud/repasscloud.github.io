...
issue urgently, email <hello@repasscloud.com> and include "Privacy" or "Security"
in the subject.
...
- Contractual protections (including Standard Contractual Clauses where
  applicable)
...
- Customer content is retained according to customer instructions and contract
  terms.
...
requests. Verification may require matching your request to existing account
details or confirming through your organisation.
